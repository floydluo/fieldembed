...
if __name__ == '__main__':
    ...
    logging.basicConfig(filename = 'English_log_field_' + str(field_num) + '.txt',
                    filemode='w',
    ...
    Data_Dir = '/home/student/data/jjluo/fieldembed/data/WikiEnglish/word/'; min_token_freq = 30
    ...
    CHANNEL_SETTINGS_TEMPLATE_FOR_WIKICN = {
        ...
        'pos_en':  {'use': True, 'tagScheme': 'BIOES'}
    }
    ...
    if field_num in [1,2,3,4]:
        ...
        EmbeddingPath = os.path.join(Data_Dir.replace('fieldembed/data', 'fieldembed/embeddings/fieldembed'), model.path)
        print(EmbeddingPath)
